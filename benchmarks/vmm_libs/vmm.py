...
import libvirt
import libvirt_qemu
from vmm_libs.cmdrunner import NativeCmdRunner
# from .cluster import KubeVirtCluster #Vasanth - Commenting unnecessary import
from vmm_libs.dut import DUT
from vmm_libs.virtxml import VirtXml
...
class VMMLibvirt(VMMBase):
    ...
    def _prepare_domain_xml(self):
        ...
        xmlobj.logfile = FRAMEWORK_LOG_DIR + "/" + self.vminst.name + ".log"
...
# Vasanth - Commenting below unnecessary class.
